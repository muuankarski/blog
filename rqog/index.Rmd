...
**rQog**: *Search, extract and format data from the Quality of Government Institute data*
...
```{rExampleStandard, cache=TRUE, message=FALSE,warning=FALSE, eval=TRUE, fig.width=12}
library(rQog)
...
```{rExampleQogSpatial, cache=TRUE, message=FALSE,warning=FALSE, eval=TRUE, fig.width=12}
